...
// StreamV1alpha1Client is used to interact with features provided by the stream group.
type StreamV1alpha1Client struct {
	restClient rest.Interface
}

func (c *StreamV1alpha1Client) Streams() StreamInterface {
	return newStreams(c)
}
...
// NewForConfigAndClient creates a new StreamV1alpha1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*StreamV1alpha1Client, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
